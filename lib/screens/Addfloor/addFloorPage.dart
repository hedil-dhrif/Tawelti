            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Text('Add new Floor',style: TextStyle(
                  fontSize: 24,
                  color: Colors.black87,
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        height: 30,
                        width: 30,
                        child: Icon(Icons.add,color: KBeige,),
    ...
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          title: Center(child: Text('Add Floor Plan',style: TextStyle(fontSize: 25,fontWeight: FontWeight.w300),)),
          ...
          child: Padding(
            ...
            child: Center(
              child: Row(
                ...
                children: [
                  Text('Add floor',style: TextStyle(fontSize: 15,color: Colors.white),)
                ],
              ),
            ),
          ),
